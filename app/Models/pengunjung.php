...
class pengunjung extends Model
{
    ...
    {
        return DB::table('tikets')->join('pakets', 'tikets.id_paket', '=', 'pakets.id_paket')->join('wisatas', 'pakets.id_wisata', '=', 'wisatas.id_wisata')->where('wisatas.id_mitra', $id_mitra)->get();
    }
