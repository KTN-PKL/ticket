...
class c_postingan extends Controller
{
    ...
    public function store(Request $request, $id_mitra)
    {
        ...
        return redirect()->route('mitra.postingan', $id_mitra)->with('success', 'Postingan Berhasil Dibuat');
    }
    ...
    public function destroy($id_wisata)
    {
        ...
        return redirect()->route('mitra.postingan', $id->id_mitra)->with('success', 'Mitra Berhasil Dihapus');
    }
}
