    ...
    <section class="section">
        <div class="col-md-12">
            <div class="card mt-2" style="border: 1px solid rgb(85, 85, 85);margin-left:2em;margin-right:2em;border-radius:0%"> 
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data"  method="POST" action="{{ route('mitra.akun.update') }}" class="form" data-parsley-validate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6 col-12">
                                ...
                                <div class="form-group mandatory">
                                    ...
                                    <input type="text" id="email" class="form-control"  name="email" data-parsley-required="true" value="{{$mitra->email}}">
                                </div>
                                <div class="form-group mandatory">
                                    <label for="username" class="form-label">Username</label>
                                    <input type="text" id="username" class="form-control"  name="username" data-parsley-required="true" value="{{$mitra->username}}">
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group mandatory">
                                    ...
                                    <input type="whatsapp" id="whatsapp" class="form-control" name="whatsapp" data-parsley-required="true" value="{{$mitra->kontak}}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group mandatory">
                                ...
                                <div class="form-group mandatory">
                                    ...
                                    <textarea type="text" id="deskripsi" class="form-control" name="deskripsi" data-parsley-required="true">{{$mitra->deskripsi_mitra}}</textarea>
                                </div>
                            </div>
                        </div>
                        <center>
