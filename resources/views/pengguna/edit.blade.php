            ...
            <div class="card mt-2" style="border: 1px solid rgb(85, 85, 85);margin-left:2em;margin-right:2em;border-radius:0%"> 
                ...
                <div class="card-body mt-4">
                  <center>
                    ...
                    <br>
                    <form enctype="multipart/form-data" method="POST" action="{{ route('pengguna.update', $pengguna->id_pengguna) }}" class="form" data-parsley-validate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group mandatory">
                                    <label for="name" class="form-label">Nama</label>
                                    <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" value="{{$pengguna->name}}" placeholder="Masukkan Nama " name="name" data-parsley-required="true">
                                    @error('name')
                                ...
                                <div class="form-group mandatory">
                                    ...
                                    <input type="text" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Masukkan Email " name="email" value="{{$pengguna->email}}" data-parsley-required="true" readonly>
                                 @error('email')
                                    <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group mandatory">
                                  ...
                                  <input type="text" id="username" class="form-control @error('username') is-invalid @enderror" placeholder="Masukkan Username " name="username" value="{{$pengguna->username}}" data-parsley-required="true" readonly>
                               @error('username')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group mandatory">
                                  ...
                                  <input type="number" id="kontak" class="form-control @error('kontak') is-invalid @enderror" placeholder="Masukkan Nomor Whatsapp " name="kontak" value="{{$pengguna->kontak}}" data-parsley-required="true">
                                  @error('kontak')
                                      <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                      </span>
